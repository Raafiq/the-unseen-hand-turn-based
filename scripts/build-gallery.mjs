...
const CAPTIONS = {
  ...
  "10-player-turn.png": "Your turn — the Archer is up (solid gold ring). Its real moveRange is painted in gold, the one enemy it could reach is tinted red, and End Turn states the price it would pay: −60 CT for a Wait.",
  ...
  "14-committed.png": "Committed — the Archer moved to (7,3) and struck from there for −100 in ONE command at −100 CT. The turn log shows both halves at the same tick (t17), which is what makes it one turn and not two.",
