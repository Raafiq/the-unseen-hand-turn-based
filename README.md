...
> **Status: M0 — all seven items built.** A pure headless simulation (`src/sim`) plus a thin viewer (`src/render`), backed by 947 tests, 47 browser specs, a determinism guard, CI, and a GitHub Pages deploy. The stack is Web / TypeScript (ADR-0007).
>
