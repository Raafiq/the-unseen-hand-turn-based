<!-- Source: https://academy.claude.com/courses/ai-native-sdlc-playbook/capture-intent (Lesson 2 of the AI-Native SDLC Playbook). Captured 2026-09-08 from the markdown mirror github.com/yibie/ai-native-sdlc-playbook, because academy.claude.com is egress-blocked in this sandbox. Verbatim below; the example intent.md was a separate chapter file in the mirror and is appended. -->
...
## What it looks like (the example intent.md, verbatim)
