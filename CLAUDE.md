...
grep the marker, don't trust it. **The skill picker shipped (ADR-0048):** pressing Skill
with two or more learned abilities opens a chip sheet above the ribbon, and reach paints
from the sim's own range rule. `docs/defects.md` §1 and §2 are retired.
